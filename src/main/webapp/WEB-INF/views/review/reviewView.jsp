...
<head>
    ...
    <script type="text/javascript">
                ...
                success: function (result) {
                    ...
                    if (result.length < 1) {
                        ...
                        $(result).each(function () {
                            ...
                            html += '<span class="btn-wrap-row edit-btn-wrap" style="float: right">';
                            html += '<a class="edit-btn" href="javascript:void(0)" onclick="btn_editReply(' + this.reply_id + ', \'' + this.member_id + '\', \'' + this.reply_content + '\' )"><img src="/resources/img/icon/edit.svg" alt="수정버튼"></a>';
                            html += '<a class="edit-btn" href="javascript:void(0)" onclick="btn_deleteReply(' + this.reply_id + ')" ><img src="/resources/img/icon/trash.svg" alt="삭제버튼"></a>';
                            html += '</span>';
                            html += '</span>';
        ...
        function btn_editReply(reply_id, member_id, reply_content) {
            ...
            htmls += '<p class="reply-content">';
            htmls += '<span class="d-block">';
            htmls += '<strong class="text-gray-dark">' + member_id + '</strong>';
            htmls += '<span class="btn-wrap-row edit-btn-wrap" style="float: right; margin-bottom: 8px">';
            htmls += '<a class="edit-btn" href="javascript:void(0)" onclick="btn_updateReply(' + reply_id + ', \'' + member_id + '\')"><img src="/resources/img/icon/reply-chk.svg" alt="저장버튼"></a>';
            htmls += '<a class="edit-btn" href="javascript:void(0)" onClick="showReplyList()"><img src="/resources/img/icon/reply-x.svg" alt="취소버튼"><a>';
            htmls += '</span>';
            htmls += '</span>';
...
<div class="sub-container">
    <div class="p-regular" style="width: 100%">
        <h3 class="s-h-imcre24" style="text-align: left; padding-left: 24px">${reviewDTO.review_title}</h3>
        <div class="review-view-info">
            <div class="review-view-left">
                ...
                <div style="display: inline-block">
                    ...
                    <div class="p-regular review-view-data">
                        <p>${reviewDTO.review_score}점</p>
                        <span>&#183;</span>
                        <a href="#" id="snack-info" style="color: #B48D69">${reviewDTO.snack_name}</a>
                        <span>&#183;</span>
                        <p>${reviewDTO.member_nickname}</p>
            ...
            <div class="btn-wrap-row" style="font-size: 14px">
                <button class="btn-Update edit-btn"><img src="/resources/img/icon/edit.svg" alt="수정버튼"></button>
                <button class="btn-Delete edit-btn"><img src="/resources/img/icon/trash.svg" alt="삭제버튼"></button>
                <a class="edit-btn" href="reviewList?num=1"><img src="/resources/img/icon/back.svg" alt="수정버튼"></a>
            </div>
        </div>
    ...
    <div class="p-regular" style="font-size: 18px; width: 100%; text-align: left">
        <p style="margin-bottom: 80px; padding-left: 24px">${reviewDTO.review_content}</p>
        <hr style="color: #CBB89B">
    </div>
    <!-- 댓글 -->
    <div class="detail-container p-regular"
         style="padding-top: 10px; flex-direction: column">
