...
<div class="sub-container">
    ...
    <form name="form" method="post">
        ...
        <div>
            <label>글제목</label>
            <input type="text" name="review_title" class="form-control" size="80" placeholder="제목을 입력하세요">
        </div>
        ...
        <div>
            <label>내용</label><br>
            <textarea cols="50" rows="5" name="review_content" class="form-control" placeholder="내용을 입력하세요"></textarea><br>
        </div>
...
<div style="width:650px; text-align: center;">
    <a href="/review/reviewList?num=1"><button>뒤로가기</button></a>
</div>
<br>
